              ...
              <div className="flex stroke">
                ...
                <div className="hidden xl:flex items-center">
                  <div className="relative md:mr-6 my-2">
                    <button className="focus:outline-none bg-red border-gray-300 border-none transition duration-150 ease-in-out hover:bg-gray-300 rounded-3xl text-gray-600 px-5 py-2 text-md text-white font-semibold">
                      Contact us
                    </button>
                  </div>
                </div>
          ...
          <div className="py-4 px-6 w-full flex xl:hidden justify-between items-center bg-white fixed top-0 z-40">
            ...
            <div className="flex items-center">
              <div className="relative mr-6 ">
                <button className="focus:outline-none bg-red border-gray-300 border-none transition duration-150 ease-in-out hover:bg-gray-300 rounded-3xl text-gray-600 px-5 py-2 text-[13px] text-white font-semibold">
                  Contact us
                </button>
              </div>
              <div
                ...
                <div className="flex flex-col justify-between h-full w-full">
                  ...
                  <div className="w-full pt-4">
                    <div className="flex justify-center mb-4 w-full">
                      <button className="focus:outline-none bg-red border-gray-300 border-none transition duration-150 ease-in-out hover:bg-gray-300 rounded-3xl text-gray-600 px-5 py-2 text-[13px] text-white font-semibold w-full">
                        Contact us
                      </button>
                    </div>
