      ...
      <div className="bg-gray-200 h-full w-full">
        ...
        <nav>
          ...
          <div
            className={
              show
                ? "w-screen xl:hidden h-screen absolute z-40  transform  translate-x-0 transition-all duration-1000"
                : "   w-screen xl:hidden h-screen absolute z-40  transform -translate-x-full transition-all duration-1000"
            }>
            <div
              className="bg-gray-800 opacity-50 w-full h-full"
              onClick={() => setShow(!show)}
            />
            <div className="w-screen z-40 fixed overflow-y-auto z-40 top-0 bg-white shadow h-screen flex-col justify-between xl:hidden pb-4 transition duration-150 ease-in-out">
